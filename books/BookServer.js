...
const cmd = require('chronos-microservice-debugger5');
...
// how does propagate work?
  // look for a trace variable on the req body
  // grab the contents of that trace variable and attatch the name of the currently microservice (__dirname???)
  //now, attach the trace to the response
